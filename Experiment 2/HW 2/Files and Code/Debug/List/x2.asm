...
_0x0:
	...
	.DB  0x65,0x64,0x20,0x0,0x25,0x64,0x20,0x3A
...
; 0000 0034     second_counter = minute_counter = hour_counter ;
	LDS  R30,_hour_counter
	LDS  R31,_hour_counter+1
	STS  _minute_counter,R30
	STS  _minute_counter+1,R31
	MOVW R12,R30
; 0000 0035 }
	LD   R31,Y+
	LD   R30,Y+
...
; 0000 0041     minute_counter++;
	LDI  R26,LOW(_minute_counter)
	LDI  R27,HIGH(_minute_counter)
	CALL SUBOPT_0x0
; 0000 0042     if(minute_counter == 60){
	LDS  R26,_minute_counter
...
; 0000 0043       minute_counter = 0 ;
	LDI  R30,LOW(0)
	STS  _minute_counter,R30
	STS  _minute_counter+1,R30
; 0000 0044       hour_counter++;
	LDI  R26,LOW(_hour_counter)
	LDI  R27,HIGH(_hour_counter)
	CALL SUBOPT_0x0
; 0000 0045     }
; 0000 0046   }
_0x5:
...
_0xA:
	...
	CPC  R5,R27
	BRNE _0xC
	LDS  R26,_hour_counter
	LDS  R27,_hour_counter+1
	CP   R8,R26
	CPC  R9,R27
	BREQ _0xD
_0xC:
...
; 0000 00E5           second_counter = minute_counter = hour_counter = 0 ;
	LDI  R30,LOW(0)
	LDI  R31,HIGH(0)
	STS  _hour_counter,R30
	STS  _hour_counter+1,R31
	STS  _minute_counter,R30
	STS  _minute_counter+1,R31
	MOVW R12,R30
; 0000 00E6         }
...
; 0000 00E9           sprintf(time , "%d : %d : %d " , hour_counter,  minute_counter , second_counter);
	...
	LDS  R31,_hour_counter+1
	CALL SUBOPT_0x1
	LDS  R30,_minute_counter
	LDS  R31,_minute_counter+1
	CALL SUBOPT_0x1
	MOVW R30,R12
	CALL SUBOPT_0x1
	LDI  R24,12
